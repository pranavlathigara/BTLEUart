...
public class BTLEUart extends ContextWrapper{
    ...
    /**
     * Write string to serive buffer, and send it to connected device
     */
     ...
     *
     * It will close connection and remove receiver. If you dont use this, it make cause memory leak
     */
